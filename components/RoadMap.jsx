...
const RoadMap = ()=>{
    ...
    return(
        <div className="relative bg-white py-16 sm:py-24 lg:py-32" id='roadmap'>
          <div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
            <p className="mt-2 text-3xl font-extrabold text-indigo-900 tracking-tight sm:text-4xl">
                    ...
                    <div className="-mt-6">
                      <div>
                        <span className="inline-flex items-center justify-center p-3 bg-indigo-500 rounded-md shadow-lg">
                          <h1 className='text-gray-50 px-2 text-xl font-bold'>
                            1
                          </h1>
                        </span>
                      </div>
                ...
                <div className="pt-6">
                  <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                    <div className="-mt-6">
                      <div>
                        <span className="inline-flex items-center justify-center p-3 bg-indigo-500 rounded-md shadow-lg">
                          <h1 className='text-gray-50 px-2 text-xl font-semibold'>
                            3
                          </h1>
                        </span>
                      </div>
                ...
                <div className="pt-6">
                  <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                    <div className="-mt-6">
                      <div>
                        <span className="inline-flex items-center justify-center p-3 bg-indigo-500 rounded-md shadow-lg">
                          <h1 className='text-gray-50 px-2 text-2xl font-medium'>
                            4
                          </h1>
                        </span>
                      </div>
